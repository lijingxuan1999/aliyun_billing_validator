...
RC_ITEMS = [
    ...
    ("WH-006", "Goods Inspection & Compliance",    "Shipment",  350.00),
...
INVOICES = [
    dict(
        ...
        charges=[
            ...
            ("WH-006", "Goods Inspection & Compliance",    8, "Shipment",  350.00,   2_800.00),
    ...
    dict(
        ...
        charges=[
            ...
            ("WH-006", "Goods Inspection & Compliance",    1, "Shipment",  350.00,     350.00),
    ...
    dict(
        ...
        charges=[
            ...
            ("WH-004", "Origin Handling Fee",              5, "Shipment", 1_200.00,  6_000.00),
            ("WH-005", "Pickup & Collection",              8, "Trip",      800.00,   6_400.00),
            ("WH-006", "Goods Inspection & Compliance",    3, "Shipment",  350.00,   1_050.00),
